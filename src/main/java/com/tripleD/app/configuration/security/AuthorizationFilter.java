...
import com.tripleD.app.configuration.exception.CustomAuthenticationException;
...
public class AuthorizationFilter extends OncePerRequestFilter {
	...
	private void authUser(String jwt) {
		...
		authorities.add(new SimpleGrantedAuthority((role.isEmpty() || (role == null)) ? "CLIENT" : role));
