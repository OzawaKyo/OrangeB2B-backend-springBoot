...
import com.tripleD.app.dto.ExceptionDTO;
...
public class ControllerExceptionHandler {
	...
	@ExceptionHandler(EnumNotFoudException.class)
	@ResponseStatus(code =HttpStatus.BAD_REQUEST )
	public ExceptionDTO HttpMessageNotReadableException(EnumNotFoudException enumNotFoudException){
		ControllerExceptionHandler.LOG.error(enumNotFoudException.getMessage());
		ExceptionDTO exceptionDTO = this.initExceptionDTO(enumNotFoudException, enumNotFoudException.getMessage() ,400,	"Bad Request");
		return exceptionDTO;
	}
